    ...
    public function run(): void
    {
        $data = [
            'Alta Verapaz' => [
                ...
                'San Pedro Carchá','Santa Cruz Verapaz','Senahú','Tactic','Tamahú',
                'Tucurú'
            ],
            'Baja Verapaz' => [
            ...
            'Chiquimula' => [
                'Camotán','Chiquimula','Concepción Las Minas','Esquipulas',
            ...
            'Huehuetenango' => [
                ...
                'San Pedro Necta','San Rafael La Independencia','San Rafael Petzal',
                'San Sebastián Coatán','Santa Ana Huista','Santa Bárbara',
                'Santa Cruz Barillas','Santa Eulalia','Santiago Chimaltenango',
                'Soloma','Tectitán','Todos Santos Cuchumatán','Unión Cantinil'
            ],
            'Izabal' => [
            ...
            'Quetzaltenango' => [
                ...
                'Colomba','Concepción Chiquirichapa','El Palmar','Flores Costa Cuca',
                'Génova','Huitán','La Esperanza','Olintepeque','Palestina de Los Altos',
                'Quetzaltenango','Salcajá','San Carlos Sija','San Francisco La Unión',
                'San Martín Sacatepéquez','San Mateo','San Miguel Sigüilá',
                'Sibilia','Zunil'
            ],
            'Quiché' => [
                'Canillá','Chajul','Chicamán','Chiché','Chichicastenango',
            ...
            'Sacatepéquez' => [
                ...
                'Santiago Sacatepéquez','Santo Domingo Xenacoj',
                'Sumpango'
            ],
            'San Marcos' => [
                'Ayutla','Catarina','Comitancillo','Concepción Tutuapa',
                'El Quetzal','El Rodeo','El Tumbador','Ixchiguán','La Blanca',
                'La Reforma','Malacatán','Nuevo Progreso','Ocós','Pajapita',
                'Río Blanco','San Antonio Sacatepéquez','San Cristóbal Cucho',
                'San José Ojetenam','San Lorenzo','San Marcos',
                'San Miguel Ixtahuacán','San Pablo','San Pedro Sacatepéquez',
                'San Rafael Pie de la Cuesta','Sibinal','Sipacapa',
                'Tacaná','Tajumulco','Tejutla'
            ],
            'Santa Rosa' => [
